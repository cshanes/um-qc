...
public class DepthSelectionFieldPanel extends JPanel implements IView {
    ...
    public DepthSelectionFieldPanel(SelectionController controller, Rectangle r, int maxHeight) {
        this.controller = controller;
        this.maxHeight = maxHeight;
        
        initComponents(r.x, r.y, r.width, r.height, maxHeight);
    }

    private void initComponents(int x, int y, int curWidth, int curHeight, int maxHeight) {
